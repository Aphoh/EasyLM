...
class OLMoConfig(PretrainedConfig):
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            ...
            `inputs_ids` passed when calling [`~OLMoModel`] or [`~TFOLMoModel`].
...
class FlaxOLMoPreTrainedModel(FlaxPreTrainedModel):
    """
...
@add_start_docstrings("", "")
class FlaxOLMoForSequenceClassification(FlaxOLMoPreTrainedModel):
    module_class = FlaxOLMoForSequenceClassificationModule
...
@add_start_docstrings("", "")
class FlaxOLMoForTokenRegression(FlaxOLMoPreTrainedModel):
    module_class = FlaxOLMoForTokenRegressionModule
