...
from EasyLM.jax_utils import float_tensor_to_dtype, tree_apply
...
class StreamingCheckpointer(object):
    ...
    def save_all(
        ...
        if is_value:
            checkpoint_name = "value_" + checkpoint_name
    ...
    @staticmethod
    def load_checkpoint(
        path, target=None, shard_fns=None, remove_dict_prefix=None, keys_to_ignore=None
    ):
